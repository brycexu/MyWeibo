...
public class WeiboController {
	...
	// 管理员删除微博
	@RequestMapping(value = "deleteWeiboByAdmin", method = RequestMethod.GET)
	public String deleteWeiboByAdmin(@RequestParam("weiboId") Integer weiboId, HttpServletResponse response,
									 HttpServletRequest request) throws Exception {
		weiboService.deleteByWeiboId(weiboId);
	...
	public String repost(HttpSession session, @RequestParam("repostId") int repostId,
		...
		// 发送时间
		Date postTime = new java.sql.Date(new Date().getTime());
	...
	public @ResponseBody String upload(MultipartFile file, Model model, HttpSession session) throws Exception {
		...
		if (file != null && originalFilename != null && originalFilename.length() > 0) {
			...
			// 存储图片的物理路径
			// String pic_path = "/Users/XuXianda/imgUpload/";
			String pic_path = "C:/Program Files/Apache Software Foundation/Tomcat 8.5/webapps/imgUpload/";
	...
	@RequestMapping(value = "queryAllWeiboNowByAdmin")
	public String queryAllWeiboNowByAdmin(Model model, @RequestParam("pageNo") int pageNo)
		  throws Exception{
	...
	public String queryAllWeiboNow(HttpSession session, Model model, @RequestParam("pageNo") int pageNo)
		...
		if (user.getNickname().equals("visitor"))
			return "/weibo/home_visitor";
		else
			return "/weibo/home";
