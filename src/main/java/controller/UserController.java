...
public class UserController {
	...
	public String allUsers(Model model) throws Exception{
		List<UserCustom> userList = userService.queryAllUsers();
	...
	public String visitor(HttpServletRequest request, HttpSession session, UserVo userVo) throws Exception {
		UserCustom userCustom = new UserCustom();
		userCustom.setUsername("visitor");
		userCustom.setPassword("visitor");
	...
	public String loginUser(HttpServletRequest request, HttpSession session, UserVo userVo) throws Exception {
		...
		if (userList.size() != 0 
			...
			session.setAttribute("password_failure", "密码错误,请重新输入");
			return "login";
		}
	}
	...
	public String deleteUser(@RequestParam("username") String username, HttpSession session, Model model) throws Exception {

		System.out.println("userName:" + username);

		// 删除用户
		weiboService.deleteByUserName(username);
